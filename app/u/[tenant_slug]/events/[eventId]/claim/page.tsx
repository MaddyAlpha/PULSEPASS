...
export default function ClaimPage() {
  const { eventId, tenant_slug } = useParams() as { eventId: string; tenant_slug: string }
  ...
  return (
    <div className="min-h-screen bg-obsidian-950 flex flex-col">
      ...
      <div className="flex items-center gap-3 px-5 py-4 border-b border-white/[0.06]"
        ...
        <Link href={`/u/${tenant_slug}/events/${eventId}`} className="p-2 rounded-lg text-white/40 hover:text-white hover:bg-white/5 transition-all">
          ...
          {step === 'failed' && (
            <motion.div key="failed" initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }}
              ...
              <div className="space-y-3">
                ...
                <Link href={`/u/${tenant_slug}/events/${eventId}`}
